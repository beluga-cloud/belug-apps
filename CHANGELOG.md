...
<a name="v0.6.0-rc.5"></a>
## [v0.6.0-rc.5] - 2022-12-21
### Dependencies
...
### Fixes
- fix some CI lint issues
- **deps:** Update module github.com/urfave/cli/v2 to v2.23.7
- **README:** ingress controller and not input controller

### Miscellaneous
- remove all assets & config managed by .github repo
- **dependencies:** update renovate conf. to use the shared one
- **milestones:** add milestones sync workflow

### Pull Requests
- Merge pull request [#100](https://github.com/belug-apps/belug-apps/issues/100) from belug-apps/renovate/actions-stale-7.x
...
## [v0.5.4] - 2022-12-08
### Fixes
- **chart:** fix helm template issue


<a name="v0.5.3"></a>
## [v0.5.3] - 2022-12-08
### Fixes
- **just:** build everything before release
...
- **README:** update dependencies badge
...
### Pull Requests
- Merge pull request [#67](https://github.com/belug-apps/belug-apps/issues/67) from belug-apps/renovate/github-actions
- Merge pull request [#68](https://github.com/belug-apps/belug-apps/issues/68) from belug-apps/fixes
...
[Unreleased]: https://github.com/belug-apps/belug-apps/compare/v0.6.0-rc.5...HEAD
[v0.6.0-rc.5]: https://github.com/belug-apps/belug-apps/compare/v0.5.4...v0.6.0-rc.5
